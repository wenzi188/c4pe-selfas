...
return [
    ...
    */
    'attributes' => [
        'password'              => 'heslo',
        'name'                  => 'CS_Name',
        'username'              => 'CS_Benutzername',
        'email'                 => 'CS_E-Mail-Adresse',
        'first_name'            => 'CS_Vorname',
        'last_name'             => 'CS_Nachname',
        'password'              => 'CS_Passwort',
        'password_confirmation' => 'CS_Passwort-Bestätigung',
        'firstname'             => 'CS_Vorname',
        'lastname'              => 'CS_Nachname',
        'role'                  => 'CS_Rolle',
        'locale'                => 'CS_Sprache',
        'password'              => 'CS_Passwort',
        'password2'             => 'CS_Passwort Bestätigung',
